...
history=model.fit(train_x, train_y, nb_epoch=10, batch_size=batch_size, verbose=2, shuffle=False) 
#model.reset_states()    
...
forecast_predict = make_forecast(model, test_x[-401:-1,:,:], timesteps=20, batch_size=batch_size)
